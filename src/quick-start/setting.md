...
::: important
请注意浏览器中url的前缀是否为`http`，如果是`https`，则需要改成`http`
!!Edge真是tiechusheng啊!!
:::
...
::: tip
首页的天数、阶段、季节获取失败的原因是无法读取游戏的核心文件，等待游戏自动保存后，就可以正常显示了，也可以手动保存 👉 [游戏指令](/src/docs/dashboard.md#游戏指令)
:::
